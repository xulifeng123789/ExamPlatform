...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	public static Date getMinTime(Date dt) {
		Date dt1 = null;
		dt1 = DateUtils.parseDate(DateUtils.formatDate(dt, "yyyy-MM-dd"));
		return dt1;
	}
	...
	public static void main(String[] args) throws Exception {
		String date1 = "2017-03";
		String date2 = "2017-03-01";
		System.out.println(TimestampToDate(DateToTimestamp(new Date())));
	}
}
