 ...
 */
package com.yyl.common.utils.string;
...
public class StringPool {
    ...
    public final static String GLOBAL_CONTEXT_KEY = "octx";
    public final static String DEFAULT_NAMESPACE = "other";
    public final static String PUBLISH_NAMESPACE = "publish";
    public final static String DEFAULT_SERVICE_PREFIX = "other-service-export-";
    ...
    public static final String BLANK_JSON = new JSONObject().toString();
    ...
    public static final String SHORT_ELLIPSIS = "...";
    public static final String LONG_ELLIPSIS = "......";
    public static final String HTTP_PROTOCOL = "http://";
    public static final String PROTOCOL_BRACKET = "://";
    public static final String HTTPS_PROTOCOL = "https://";
    public static final String SPRING_FILE_PROTOCOL = "file:";
    public static final String OPEN_QUOTE_BRACKET = "['";
    public static final String CLOSE_QUOTE_BRACKET = "']";
    public static final String YES = "yes";
    public static final String NO = "no";
    public static final String NEW_LINE_RTN = "\n\t";
